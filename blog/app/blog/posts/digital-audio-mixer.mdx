...
The hardware of the mixer needs to handle two main tasks, amplication and conversion. I'm currently working on a prototype microphone preamp, and I will write up on it soon. 
...
There's an old YouTube video on mixing that summarizes these concepts well with its thumbnail. Here it is for a bit of a visual representation. Source: [The Art of Mixing](https://www.youtube.com/watch?v=TEjOdqZFvhY)
...
[AI Instrument Classifier](https://joshieyu-audioclassifier.hf.space/)
...
It operates off the same principles as my demo model, just with much more training data and a more robust architecture. It delivers over 500 classes of granularity and native support for Tensorflow Lite, 
